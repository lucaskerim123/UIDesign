...
export async function POST(req:NextRequest){
 ...
 const token=auth.slice(7),url=process.env.NEXT_PUBLIC_SUPABASE_URL||"https://xwbjfhpgsvsjaykelufa.supabase.co",key=process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY||"";
