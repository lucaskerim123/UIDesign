-- Enforce structured Support -> Senior Support -> Administrator -> Superadmin escalation.
...
begin
  ...
  if t.escalation_level>greatest(rank-1,0) then raise exception 'ticket is escalated above your support level'; end if;
